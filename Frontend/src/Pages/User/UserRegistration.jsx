...
import { addFarmer, addUserFailureAction, addUserSuccessAction } from "../../Redux/userReducer/action";
...
export default function UserRegistration({onClose}) {
  ...
  console.log("farmer reducer", data);
