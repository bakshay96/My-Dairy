...
<table width="100%" cellpadding="0" cellspacing="0" style="padding:24px 0;background:#f1f5f9;">
  ...
  <table width="560" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.10);">
    ...
    <!-- Header -->
    <tr>
      <td style="background:linear-gradient(135deg,#0d4f2f 0%,#1e3a5f 100%);padding:28px 32px;text-align:center;">
        <div style="margin-bottom:10px;font-size:36px;">🥛</div>
        <h1 style="margin:0;color:#fff;font-size:20px;font-weight:800;letter-spacing:1.5px;">MILK COLLECTION RECEIPT</h1>
        <p style="margin:6px 0 0;color:rgba(255,255,255,0.7);font-size:12px;letter-spacing:2px;">MILKIFY DAIRY MANAGEMENT</p>
      </td>
    </tr>
          ...
          <tr>
            <td style="width:33%;padding-right:6px;">
              <div style="background:#f0fdf4;border:1px solid #bbf7d0;border-radius:10px;padding:14px;text-align:center;">
                ...
                <p style="margin:5px 0 0;font-size:22px;font-weight:800;color:#14532d;">${litter}<span style="font-size:12px;font-weight:500;"> L</span></p>
              </div>
            </td>
            <td style="width:33%;padding:0 3px;">
              <div style="background:#fff7ed;border:1px solid #fed7aa;border-radius:10px;padding:14px;text-align:center;">
                ...
                <p style="margin:5px 0 0;font-size:18px;font-weight:800;color:#7c2d12;">${fat}<span style="font-size:11px;">%</span> / ${snf}</p>
              </div>
            </td>
            <td style="width:33%;padding-left:6px;">
              <div style="background:#f0f9ff;border:1px solid #bae6fd;border-radius:10px;padding:14px;text-align:center;">
                ...
                <p style="margin:5px 0 0;font-size:18px;font-weight:800;color:#0c4a6e;">${amountFmt}</p>
              </div>
            </td>
          </tr>
        </table>
    ...
    <tr>
      ...
      ["🥛 Litter ", litter],
          ...
          <tr style="background:#0d4f2f;">
            ...
            <td style="padding:12px 16px;font-size:16px;font-weight:800;color:#86efac;text-align:right;">${amountFmt}</td>
          </tr>
        </table>
      </td>
    </tr>
    ...
    <tr>
      <td style="background:#f8fafc;border-top:1px solid #e2e8f0;padding:20px 32px;text-align:center;">
        ...
        <p style="margin:6px 0 0;font-size:11px;color:#cbd5e1;">
          Powered by <strong style="color:#1e3a5f;">Milkify</strong> · Digital Dairy Management System
        </p>
      </td>
    </tr>
